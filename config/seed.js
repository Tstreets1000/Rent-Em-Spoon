...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Lentile Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Tomato Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'New England Clam Chowder', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'French Onion Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Chicken Tortilla Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Butternut Squash Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Beef & Barley Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Corn Chowder', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Chicken & Rice Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Split Pea Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Bouillbaisse', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Cream of Mushroom Soup', emoji: "🍵", category: categories[4], price: 0.00},
    {name: 'Miso', emoji: "🍵", category: categories[4], price: 0.00},
